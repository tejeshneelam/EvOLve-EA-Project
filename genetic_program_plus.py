...
class GPTree:
    ...
    def draw_tree(self, fname, footer):
        ...
        # optional display (safe even if it fails)
        try:
...
def prepare_plots():
    ...
    # ✅ FIX for macOS / new Matplotlib
    fig.suptitle('EVOLUTIONARY PROGRESS', fontsize=16)
    ...
    line[0], = axarr[0].plot(xdata, ydata[0], 'b-')
    line[1], = axarr[1].plot(xdata, ydata[1], 'r-')
